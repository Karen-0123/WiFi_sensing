function featureTable = export_sleep_features(bpm_deviation, var_history, num_events, all_90th_percentile, varience, csv_filename, seg_start_times, seg_end_times, wake_sleep)
