...
## 開發環境與技術棧
* **硬體設備**：Intel 5300
* **後端演算法**：Python 3.x / MATLAB Engine API for Python / OS Windows Samba
* **資料庫管理**：SQLite 3
...
重要提示：首次進入請點擊藍色**「Visit Site」**按鈕繞過安全提示頁面
[https://armband-exact-multiply.ngrok-free.dev/wifi_sensing/WiFi_sensing/sleep_monitor/WebApp/index.html](https://armband-exact-multiply.ngrok-free.dev/wifi_sensing/WiFi_sensing/sleep_monitor/WebApp/index.html)
