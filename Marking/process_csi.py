...
# ================= 設定區域 =================
# 1. 檔案路徑
CSI_FILE_PATH = "data/flip50hzR_20s_007.dat"
OUTPUT_ROOT = "dataset_output/50hz_007"  # 輸出資料夾名稱
...
LABEL_INTERVALS = [
    ...
    ("noise", 0, 200),  # 躺下
    ("flipping", 950, 1150),  # 右翻1
    ("static", 1150, 1950),
    ("flipping", 1950, 2250),  # 翻回1
    ("static", 2250, 2900),

    ("flipping", 2900, 3100),  # 右翻2
    ("static", 3100, 3950),
    ("flipping", 3950, 4250),  # 翻回2
    ("static", 4250, 4950),

    ("flipping", 4950, 5150),  # 右翻3
    ("static", 5150, 5950),
    ("flipping", 5950, 6150),  # 翻回3
    ("static", 6150, 6900),

    ("flipping", 6900, 7100),  # 右翻4
    ("static", 7100, 7900),
    ("flipping", 7900, 8100),  # 翻回4
    ("static", 8100, 8900),

    ("flipping", 8900, 9100),  # 右翻5
    ("static", 9100, 9950),
    ("flipping", 9950, 10150),  # 翻回5
    ("static", 10150, 10857),
    ("noise", 10857, 11057),     # 起身
]
# ===========================================
