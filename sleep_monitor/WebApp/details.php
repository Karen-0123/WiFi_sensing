<?php
// 測試標記：若瀏覽器有出現此黃底紅字，代表載入路徑完全正確；確認後可自行刪除此行
echo "<div style='background: #fff3cd; color: #856404; padding: 10px; text-align: center; font-weight: bold; border-bottom: 1px solid #ffeeba;'>TEST 123 - 正確載入最新版檔案</div>";

session_start();
if (!isset($_SESSION['user_id'])) { 
    // 若尚未登入，給予預設值 1 方便本地除錯，避免被強制導向
    $_SESSION['user_id'] = 1; 
}
        ...
        const hypnoOption = {
            ...
            series: [{
                ...
                renderItem: function (params, api) {
                    ...
                    // 繪製切換到下個階段的垂直連接線 (Apple 原生階梯連接特效)
